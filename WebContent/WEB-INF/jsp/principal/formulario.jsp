...
<div data-role="content">
		...
		<form action="#" method="get">
			...
			<p>There is a complete set of <a href="<c:url value="scripts/jquery.mobile-1.1.0/demos/docs/forms/forms-all-mini.html"/>" >mini-sized</a> form elements which are useful for toolbars or tighter spaces. <a href="forms-all-compare.html">Compare mini and normal</a> form elements side-by-side.</p>
